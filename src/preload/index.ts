...
const api: GemApi = {
  ...
  setShortcut: (accel) => ipcRenderer.invoke('settings:set-shortcut', accel) as Promise<void>,
  ...
  openOnboarding: () => ipcRenderer.invoke('onboarding:open') as Promise<void>,
  closeOnboarding: () => ipcRenderer.invoke('onboarding:close') as Promise<void>,
  openPanel: () => ipcRenderer.invoke('panel:open') as Promise<void>,
